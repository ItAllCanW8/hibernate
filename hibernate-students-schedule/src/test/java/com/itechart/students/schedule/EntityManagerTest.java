...
public class EntityManagerTest extends AbstractTest {
    ...
    public void testMerge() {
        PersonSimplified person = em.find(PersonSimplified.class, 14L);
...
//         em.detach(person);
    ...
    public void testRemove() {
        PersonSimplified person = em.getReference(PersonSimplified.class, 15L);
        executeInTransaction(() -> {
            em.remove(person);
        });

        PersonSimplified nullPerson = em.find(PersonSimplified.class, 15L);
